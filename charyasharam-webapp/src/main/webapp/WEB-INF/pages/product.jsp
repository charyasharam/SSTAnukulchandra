...
<ul class="nav nav-tabs">
	  <li role="presentation"><a href="/thakur/home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	  <li role="presentation"><a href="/thakur/prayer"><span class="glyphicon glyphicon-user"></span> Customer</a></li>
	  <li role="presentation" class="active"><a href="/thakur/books">Product</a></li>
	</ul>
